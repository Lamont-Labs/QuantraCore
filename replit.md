...
- **Alpaca Markets API:** Primary broker for paper trading execution ($100k equity). Historical data requires separate data subscription (currently 403 for bars endpoint).
