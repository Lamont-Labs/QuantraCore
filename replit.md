...
- **Simulation-Based Data Augmentation:** Multiplies training samples using real data variations without creating fake data: (1) Entry timing shifts (+/- bars), (2) Monte Carlo bootstrapping, (3) Rare event oversampling (runners 3x, crashes 2x). Endpoint: `POST /apexlab/train-augmented`. Can achieve 2-5x data multiplication.
